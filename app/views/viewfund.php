            ...
            <div class="r5">
                ...
                <div class="c4">
                    ...
                    <div class="smbuttons" id="smbuttons">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=<?=$data['fund']->title?>&url=http://localhost//SMILE/SMILE-git/SMILE-Codes/public/singlefund/<?=$data['category']?>/<?=$data['id']?>" class="fa fa-twitter"></a>
                        <a href="https://t.me/share/url?url=http://localhost//SMILE/SMILE-git/SMILE-Codes/public/singlefund/<?=$data['category']?>/<?=$data['id']?>&<?=$data['fund']->title?>" class="fa fa-telegram" aria-hidden="true"></a>
