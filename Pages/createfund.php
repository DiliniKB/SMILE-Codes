...
<body>
    ...
    <div id="form">
        <div class="row">   
            ...
            <form action="insertfund.php" method="post" style="margin:0px;" class="column" id="inputs"> 
                <input class="input_form" type="currency" placeholder="Rs." name="amount" >
                <input class="input_form" type="text" placeholder="Keywords" name="keywords">
                <input class="input_form" type="text" placeholder="Town" name="town" >
                <input class="input_form" type="text" placeholder="District" name="District" >
                <input class="input_form" type="text" placeholder="Title of the Fund" name="Title" >
                <input class="input_form" type="text" placeholder="Description" name="Description" >
                <input class="input_form" type="text" placeholder="Account Number" name="accNo" >
                <input class="input_form" type="text" placeholder="Name of the Bank" name="bankName" >
                <input class="input_form" type="text" placeholder="Name of the Branch" name="branchName" >
                <input class="input_form" type="text" placeholder="Account Holder" name="accountHolder" >
